...
\fill[Trace] (-2.5,0) -- (-1.5,0) -- (-1.7,0.5) -- (-2.3,0.5) -- cycle;
\fill[Trace] (1.5,0) -- (2.5,0) -- (2.3,0.5) -- (1.7,0.5) -- cycle;
...
\draw[<->] (-2.3,0.55) -- (-1.7,0.55) node[midway, above] {$w - \Delta w$};
\draw[<->] (1.7,0.55) -- (2.3,0.55) node[midway, above] {$w - \Delta w$};
\draw[<->] (-2.5,0.05) -- (-1.5,0.05) node[midway, below] {$w$};
\draw[<->] (1.5,0.05) -- (2.5,0.05) node[midway, below] {$w$};
\draw[<->] (-0.5,0.05) -- (-1.5,0.05) node[midway, above] {$s$};
\draw[<->] (0.5,0.05) -- (1.5,0.05) node[midway, below] {$s$};
\draw[<->] (-2.55,0) -- (-2.55,0.5) node[midway, left] {$t$};
\draw[<->] (2.55,0) -- (2.55,0.5) node[midway, right] {$t$};
\draw[<->] (-3.55,-1.0) -- (-3.55,0) node[midway, right] {$h_1$};
\draw[<->] (-3.55,-2.0) -- (-3.55,-1.0) node[midway, right] {$h_2$};
