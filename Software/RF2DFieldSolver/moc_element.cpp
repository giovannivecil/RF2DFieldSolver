...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Element_t, stringdata0) + ofs), len 
...
void Element::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Element::typeChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Element::staticMetaObject = { {
    ...
    qt_meta_stringdata_Element.offsetsAndSize,
    qt_meta_data_Element,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Element_t
, QtPrivate::TypeAndForceComplete<Element, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
