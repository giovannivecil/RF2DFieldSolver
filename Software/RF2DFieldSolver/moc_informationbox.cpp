...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_InformationBox_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_InformationBox_t qt_meta_stringdata_InformationBox = {
    {
QT_MOC_LITERAL(0, 14) // "InformationBox"
...
const QMetaObject InformationBox::staticMetaObject = { {
    ...
    qt_meta_stringdata_InformationBox.offsetsAndSize,
    qt_meta_data_InformationBox,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_InformationBox_t
, QtPrivate::TypeAndForceComplete<InformationBox, std::true_type>
